...
public class subtration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtration);
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(m==x && n==y){
                    ...
                    double[][] resultMatrix = sub_matrix(matrixa,matrixb,m,n);
...
//        String[] values = rows[i].trim().split(",\\s*");
    ...
    public double[][] sub_matrix(double[][] arr,double[][] ar,int m,int n) {
